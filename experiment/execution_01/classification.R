...
# create directories
#
dir.create("/opt/classification/results/experiment_01a", recursive = TRUE)
dir.create("/opt/classification/results/experiment_01b", recursive = TRUE)

#
# generate the first result
#
do_classification("/opt/classification/results/experiment_01a")

#
# generate the second result
#
do_classification("/opt/classification/results/experiment_01b")
